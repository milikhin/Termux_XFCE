...
pkg install git mesa-vulkan-icd-freedreno-dri3 neofetch virglrenderer-android papirus-icon-theme xfce4 xfce4-goodies pavucontrol-qt exa bat jq wmctrl firefox netcat-openbsd -y
